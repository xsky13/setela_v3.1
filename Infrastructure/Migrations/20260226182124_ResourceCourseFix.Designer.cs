...
namespace SetelaServerV3._1.Infrastructure.Migrations
{
    ...
    [Migration("20260226182124_ResourceCourseFix")]
    partial class ResourceCourseFix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SetelaServerV3._1.Domain.Entities.Assignment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SetelaServerV3._1.Domain.Entities.AssignmentSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SetelaServerV3._1.Domain.Entities.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SetelaServerV3._1.Domain.Entities.ExamSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("AdminExtendedTime")
                        .HasColumnType("boolean");
                    ...
                    b.Property<DateTime>("LastUdated")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("SetelaServerV3._1.Domain.Entities.UserProgress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SetelaServerV3._1.Domain.Entities.AssignmentSubmission", b =>
                {
                    b.HasOne("SetelaServerV3._1.Domain.Entities.Assignment", "Assignment")
            ...
            modelBuilder.Entity("SetelaServerV3._1.Domain.Entities.ExamSubmission", b =>
                {
                    b.HasOne("SetelaServerV3._1.Domain.Entities.Exam", "Exam")
